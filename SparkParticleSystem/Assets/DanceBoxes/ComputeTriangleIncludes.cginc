//Code ripped shamelessly from this site:
...
int check_point(float3 p1, float3 p2, float alpha, int mask)
{
float3 plane_point;
...
int check_line(float3 p1, float3 p2, int outcode_diff)
{
...
int point_triangle_intersection(float3 p, Triangle3 t)
{
...
int t_c_intersection(Triangle3 t)
{
...
int TriangleIntersectsUnitSquare(float3 p1, float3 p2, float3 p3)
{
	Triangle3 t;
	t.v1 = p1;
	t.v2 = p2;
